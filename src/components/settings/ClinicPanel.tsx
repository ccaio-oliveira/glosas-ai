    ...
    return (
        <Card>
            ...
            <div className="grid grid-cols-2 gap-4">
                <Input label="Nome da clínica" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} />
                <Input label="CNPJ" value={form.cnpj} onChange={(e) => setForm({ ...form, cnpj: e.target.value })} />
                <Input label="CRO" value={form.cro} onChange={(e) => setForm({ ...form, cro: e.target.value })} />
